...
select  employee_id, last_name,
        ...
        to_char(salary*commission_pct, '$9999.99') as "perSal"
from    employees
...
-- 6. 날짜를 문자로 변환해야하는건 못했어요~ㅜㅜ
select  last_name, hire_date,
        case  when hire_date > '04/12/31' then 'New employee'
              when hire_date < '04/12/31' then 'Career employee'
              else hire_date
        end
from    employees
